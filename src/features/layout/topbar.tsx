      ...
      <div className="bg-gov-header text-white">
        <div className="flex items-center justify-between px-4 py-1.5 text-[11px]">
          <div className="flex items-center gap-3">
            <span className="opacity-90">🇮🇳 Ministry of Commerce · Export Documentation Wing</span>
          </div>
        ...
        <div className="flex items-center gap-4 px-4 py-2.5">
          <div className="flex items-center gap-3">
            ...
            <div className="leading-tight">
              <div className="font-serif text-[15px] font-bold">Export Application Management System</div>
              <div className="text-[11px] text-muted-foreground uppercase tracking-wider">Approval-Driven Documentation Workflow</div>
            </div>
          </div>

          <div className="flex-1 max-w-xl mx-auto relative">
            <Search className="h-4 w-4 absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground" />
            <Input placeholder="Search applications, invoices, containers, BL, customers…" className="pl-9 h-9" />
          </div>

...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Shreehari Export House — Staff Portal" },
      { name: "description", content: "Staff login for Shreehari Export House export documentation workflow." },
      { property: "og:title", content: "Shreehari Export House — Staff Portal" },
